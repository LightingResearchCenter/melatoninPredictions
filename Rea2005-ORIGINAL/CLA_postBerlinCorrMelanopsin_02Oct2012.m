...
% save('spectralSensitivitiesRea2011.mat', 'wavelength_spd', 'Vlambda', 'Vprime', 'Scone', 'macularTi', 'M')
% pause

%     figure
%     plot(wavelength_spd, Vlambda, wavelength_spd, Vprime, wavelength_spd, Scone, wavelength_spd, macularTi, wavelength_spd, M)
%     legend('V(l)', 'V"(l)', 'SCone', 'macular', 'OPN4')
%     pause
